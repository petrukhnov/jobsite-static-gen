 ...
 * @return {*}
 */
module.exports = function (blogposts, authors, rst_blogposts, md_blogposts) {
    return (blogposts && blogposts.results && getViewmodel(viewmodel.getBlogpost, blogposts))
        ...
        || (md_blogposts && md_blogposts.results && getViewmodel(viewmodel.getMdBlogpost, md_blogposts))
        || {};
